...
<html lang="en">
	<head>
		<meta charset="utf-8"/>
		<title>Influenza - Health Journal </title>
		...
		?>
			<div id="main" >
				<div class="container-fluid" >
					<h2 class="heading" style="text-align:left; border-bottom:10px solid #37B482;"> <?php echo $lang['influenza']; ?> </h2>
					
					<div class="tip" style="float:left;">
						<a href="alzheimer.php"><i id="arrow" class="material-icons">arrow_back</i></a>
						<span style="color:white;"class="tooltiptext"> <?php echo $lang['alzheimer']; ?> </span>
					</div>
					
					<div class="tip" style="float:right;">
						<a href="hiv.php"><i id="arrow" class="material-icons">arrow_forward</i></a>
					...
					<div class="row" style="background-color:#37B482; color:white; border-radius:10px; padding:20px;">
						...
						<div class="col-sm-8">
							<p> <?php echo nl2br($lang['influenza intro']); ?> </p>
						</div>
					</div>
					<br></br><br></br>
					...
					<div class="row">
						...
						<div class="col-sm-8">
							<br></br>
							<p> <?php echo $lang['influenza symptoms']; ?> </p>
						</div>
						<div class="col-sm-4">
							<img src="images/influenza.jpg" alt= <?php echo $lang['alt about diseases 6']; ?>  class="image"></img>
						</div>
					</div>
					...
					<div class="row">
							...
							<br></br>
							<p> <?php echo $lang['influenza prevention']; ?> </p>
					</div>
					...
					<div class="row" style="background-color:#37B482; border-radius:10px; padding:20px">
						<h3 class="heading" style="text-align:left;"> <?php echo $lang['treatment']; ?> </h3>
							<br></br>
							<p> <?php echo $lang['influenza treatment']; ?> </p>
					</div>
				</div>
			</div>
